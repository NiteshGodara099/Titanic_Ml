...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"C:/Users/nites/Projects/Titanic-ml/tenv/python.exe",
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"C:/b/abs_f2u2o_8s9g/croot/contourpy_1732540071787/work/.mesonpy-boy_x685/lib/contourpy/util",
        source_dir=r"C:/b/abs_f2u2o_8s9g/croot/contourpy_1732540071787/work/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True '--native-file=C:/b/abs_f2u2o_8s9g/croot/contourpy_1732540071787/work/.mesonpy-boy_x685/meson-python-native-file.ini'",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
        ...
        # C++ compiler
        compiler_name="msvc",
        compiler_version="19.29.30156",
        linker_id="link",
        compile_command="cl.exe",
